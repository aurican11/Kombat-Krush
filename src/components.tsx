...
import type { GameState, Opponent, CharacterName, Piece, SpecialEffect, TextPopup, AbilityState } from './types.ts';
import { CHARACTER_DATA, PieceIcons, PLAYER_MAX_HEALTH, ABILITY_METER_MAX } from './constants.tsx';
